...
@Entity
@Builder
@Table(name = "TB_WORKING_DAYS_PLAN")
public class WorkingDaysPlan extends AuditableEntity<Long> implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "WORKING_DAYS_PLAN_ID", columnDefinition = "bigint", nullable = false)
    private Long id;
